...
class FactorVAE(nn.Module):
    ...
    def forward(self, x, returns):
        ...
        # TODO 下面两个到底哪个更好，还需要测试，是否更看重排名的损失函数？
        ...
        print(
            f"reconstruction_loss={reconstruction_loss:.4f}: kl_divergence={kl_divergence:.4f}: rank_loss={rank_loss:.4f}")
